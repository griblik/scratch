...
thing = df.loc[df['Direction'] == 'Incoming']
inlist = thing['In'].tolist()
...
user1 = user1[user1['CallDate'].dt.dayofweek >= 5]
...
fig = plt.figure()
ax = fig.add_subplot(111)
ax.scatter(centroids[:,0], centroids[:,1], c='b', marker='.')
ax.set_title('Kmeans output')
showandtell()  # TODO: Comment this line out when you're ready to proceed
